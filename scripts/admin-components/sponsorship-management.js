...
(function() {
    ...
    function attachEventListeners() {
        ...
        if (elements.container) {
            elements.container.addEventListener('click', handleSponsorAction, false);
        }
    }
    ...
    function handleSponsorAction(e) {
        console.log('Sponsor action clicked', e.target);
        ...
        if (editBtn) {
            ...
            console.log('Editing sponsor ID:', sponsorId);
            if (sponsorId) {
                try {
        ...
        if (deleteBtn) {
            ...
            console.log('Deleting sponsor ID:', sponsorId);
            if (sponsorId) {
                try {
    ...
    function createSponsorCard(sponsor) {
        ...
        card.innerHTML = `
            ...
            <div class="sponsor-actions">
                <button class="edit-btn" data-id="${sponsor.id}" type="button" title="Edit Sponsor">
                    <i class="fas fa-pencil"></i> Edit
                </button>
                <button class="delete-btn" data-id="${sponsor.id}" type="button" title="Delete Sponsor">
    ...
    function showNotification(message, type = 'success') {
        ...
        notification.style.cssText = `
            ...
            color: white; border-radius: 8px; font-weight: 500; z-index: 999999;
