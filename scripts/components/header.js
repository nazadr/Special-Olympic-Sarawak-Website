...
document.writeln(`
    <nav class="top-nav">
        <div class="logo">
            <a href="../index.php" class="desktop-only"><img src="../assets/images/SO Malaysia.png" alt="SO Malaysia Logo" class="logo-img"></a>
            <span class="desktop-only" style="color: #999; font-size: 28px; font-weight: 300; margin: 0 8px; line-height: 1;">|</span>
